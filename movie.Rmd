...
five_most_ranked_movies = top_view_1$title[1:5]

five_most_ranked_movies[1]
```
...
```{r}
# Barplot basique
p = ggplot(data=ranking_per_year, aes(x=year, y=Ranking_Total_Per_Year)) +
...
p
```
##4. Tags les plus populaires par annee 
```{r}
#Pour chaque année, les 5 tags les plus populaires (horreur, science, etc)
